...
checkpoint<Base>::checkpoint(const char *name, Algo &algo, const ADVector &ax, ADVector &ay, option_enum sparsity,
                             bool optimize)
    ...
    if (optimize) {  // suppress checking for nan in f_ results
