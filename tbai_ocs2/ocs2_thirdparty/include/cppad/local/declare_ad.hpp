...
template <class Base>
class AD;
template <class Base, class RecBase = Base>
class ADFun;
template <class Base>
class atomic_base;
template <class Base>
...
template <class Base>
bool Constant(const VecAD<Base> &u);
template <class Base>
bool Dynamic(const VecAD<Base> &u);
template <class Base>
...
template <class Base>
bool Constant(const AD<Base> &u);
template <class Base>
bool Dynamic(const AD<Base> &u);
template <class Base>
...
template <class Base>
bool IdenticalCon(const AD<Base> &u);
template <class Base>
...
// CondExpOp
template <class Base>
AD<Base> CondExpOp(enum CompareOp cop, const AD<Base> &left, const AD<Base> &right, const AD<Base> &trueCase,
