...
class sparse_sizevec {
    ...
    */
    sparse_sizevec(void) : end_(0), data_not_used_(0), data_(0), start_(0), post_(0) {}
    // -----------------------------------------------------------------
    /// Destructor
    ~sparse_sizevec(void) { check_data_structure(); }
    // -----------------------------------------------------------------
    /*!
    ...
    */
    sparse_sizevec(const sparse_sizevec &v) {  // Error: Probably a sparse_sizevec argument has been passed by value
    ...
    */
    void assignment(size_t this_target, size_t other_source, const sparse_sizevec &other) {
        ...
        } else {  // make a copy of the other list in this sparse_sizevec
...
class sparse_sizevec_const_iterator {
   ...
   public:
    ...
    sparse_sizevec_const_iterator(const sparse_sizevec &vec_set, size_t i) : data_(vec_set.data_), end_(vec_set.end_) {
...
void sparsity_user2internal(sparse_sizevec &internal, const SetVector &user, size_t n_set, size_t end, bool transpose,
