...
class const_random_iterator {
    ...
    */
    const_random_iterator(const pod_vector<opcode_t> &op_vec,  ///< op_vec_
    ...
    */
    void op_info(size_t op_index, OpCode &op, const addr_t *&op_arg, size_t &var_index) const {
    ...
    */
    size_t var2op(size_t var_index) const {  // check that var2op_vec was not null in constructor
    ...
    OpCode get_op(size_t op_index) const { return OpCode((*op_vec_)[op_index]); }
    /// number of operators
    size_t num_op(void) const { return op_vec_->size(); }
    //
    /// number of variables
    size_t num_var(void) const { return var2op_vec_->size(); }
};
