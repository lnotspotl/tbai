...
*/
template <class Base>
void forward_store_op_0(size_t i_z, const addr_t *arg, size_t num_par, size_t cap_order, Base *taylor,
                        bool *isvar_by_ind, size_t *index_by_ind) {
...
void sparse_store_op(OpCode op, const addr_t *arg, size_t num_combined, const size_t *combined,
...
*/
template <class Base>
void forward_store_pp_op_0(size_t i_z, const addr_t *arg, size_t num_par, size_t cap_order, Base *taylor,
                           bool *isvar_by_ind, size_t *index_by_ind) {
    addr_t i_vec = arg[1];
...
*/
template <class Base>
void forward_store_pv_op_0(size_t i_z, const addr_t *arg, size_t num_par, size_t cap_order, Base *taylor,
                           bool *isvar_by_ind, size_t *index_by_ind) {
    addr_t i_vec = arg[1];
...
*/
template <class Base>
void forward_store_vp_op_0(size_t i_z, const addr_t *arg, size_t num_par, size_t cap_order, Base *taylor,
                           bool *isvar_by_ind, size_t *index_by_ind) {
...
*/
template <class Base>
void forward_store_vv_op_0(size_t i_z, const addr_t *arg, size_t num_par, size_t cap_order, Base *taylor,
                           bool *isvar_by_ind, size_t *index_by_ind) {
    addr_t i_vec = addr_t(Integer(taylor[size_t(arg[1]) * cap_order + 0]));
    CPPAD_ASSERT_KNOWN(size_t(i_vec) < index_by_ind[arg[0] - 1],
                       "VecAD: index during zero order forward sweep is out of range");
...
*/
template <class Vector_set>
void forward_sparse_store_op(bool dependency, OpCode op, const addr_t *arg, size_t num_combined, const size_t *combined,
                             Vector_set &var_sparsity, Vector_set &vecad_sparsity) {
    ...
    if ((op == StpvOp) | (op == StvvOp)) vecad_sparsity.binary_union(i_v, i_v, size_t(arg[2]), var_sparsity);
...
*/
template <class Vector_set>
void reverse_sparse_jacobian_store_op(bool dependency, OpCode op, const addr_t *arg, size_t num_combined,
    ...
    if ((op == StpvOp) | (op == StvvOp)) var_sparsity.binary_union(size_t(arg[2]), size_t(arg[2]), i_v, vecad_sparsity);
...
*/
template <class Vector_set>
void reverse_sparse_hessian_store_op(OpCode op, const addr_t *arg, size_t num_combined, const size_t *combined,
