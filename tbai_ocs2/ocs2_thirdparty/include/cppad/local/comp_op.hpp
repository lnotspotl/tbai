...
*/
template <class Base>
void forward_lepp_op_0(size_t &count, const addr_t *arg, const Base *parameter) {
    // check assumptions
...
*/
template <class Base>
void forward_ltpp_op_0(size_t &count, const addr_t *arg, const Base *parameter) {
    // check assumptions
...
*/
template <class Base>
void forward_eqpp_op_0(size_t &count, const addr_t *arg, const Base *parameter) {
    // check assumptions
...
*/
template <class Base>
void forward_nepp_op_0(size_t &count, const addr_t *arg, const Base *parameter) {
    // check assumptions
