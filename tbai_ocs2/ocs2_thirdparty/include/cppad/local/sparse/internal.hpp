...
void set_internal_pattern(bool zero_empty, bool input_empty, bool transpose, const pod_vector<size_t> &internal_index,
...
*/
template <class SizeVector, class InternalSparsity>
void get_internal_pattern(bool transpose, const pod_vector<size_t> &internal_index,
