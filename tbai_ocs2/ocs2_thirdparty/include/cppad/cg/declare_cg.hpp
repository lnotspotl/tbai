...
template <class Base>
cg::CG<Base> CondExp(cg::CGOpCode op, const cg::CG<Base> &left, const cg::CG<Base> &right, const cg::CG<Base> &trueCase,
                     const cg::CG<Base> &falseCase, bool (*compare)(const Base &, const Base &));
