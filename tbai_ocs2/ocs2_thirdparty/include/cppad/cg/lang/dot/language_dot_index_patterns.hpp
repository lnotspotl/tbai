...
template <class Base>
inline void LanguageDot<Base>::printRandomIndexPatternDeclaration(
    std::ostringstream &os, const std::set<RandomIndexPattern *> &randomPatterns) {
    ...
    for (RandomIndexPattern *ip : randomPatterns) {
        ...
        if (ip->getType() == IndexPatternType::Random1D) {
            ...
            for (const std::pair<size_t, size_t> &p : x2y) y[p.first] = p.second;
...
template <class Base>
void LanguageDot<Base>::printStaticIndexArray(std::ostringstream &os, const std::string &name,
...
template <class Base>
void LanguageDot<Base>::printStaticIndexMatrix(std::ostringstream &os, const std::string &name,
...
template <class Base>
inline void LanguageDot<Base>::indexPattern2String(std::ostream &os, const IndexPattern &ip,
...
template <class Base>
inline void LanguageDot<Base>::linearIndexPattern2String(std::ostream &os, const LinearIndexPattern &lip,
                                                         const OperationNode<Base> &index) {
