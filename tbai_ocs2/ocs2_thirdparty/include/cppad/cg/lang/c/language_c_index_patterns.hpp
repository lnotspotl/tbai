...
template <class Base>
inline void LanguageC<Base>::printRandomIndexPatternDeclaration(std::ostringstream &os, const std::string &indentation,
...
template <class Base>
void LanguageC<Base>::printStaticIndexArray(std::ostringstream &os, const std::string &name,
...
template <class Base>
void LanguageC<Base>::printStaticIndexMatrix(std::ostringstream &os, const std::string &name,
