...
template <class Base>
inline size_t LanguageLatex<Base>::printArrayCreationUsingLoop(size_t startPos, OperationNode<Base> &array,
                                                               size_t starti,
...
template <class Base>
inline void LanguageLatex<Base>::printArrayStructInit(const std::string &dataArrayName, size_t pos,
