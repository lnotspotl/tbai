...
class CG {
   ...
   protected:
    ...
    // CondExp function
    friend CG<Base> CondExp<Base>(CGOpCode op, const CG<Base> &left, const CG<Base> &right, const CG<Base> &trueCase,
                                  const CG<Base> &falseCase, bool (*compare)(const Base &, const Base &));
