...
template <class Base>
bool time_diff_forward(size_t id, size_t order, size_t n, size_t m, const CppAD::vector<bool> &vx,
                       CppAD::vector<bool> &vzy, const CppAD::vector<CG<Base> > &tx, CppAD::vector<CG<Base> > &tzy) {
...
template <class Base>
bool time_diff_reverse(size_t id, size_t order, size_t n, size_t m, const CppAD::vector<CG<Base> > &tx,
                       const CppAD::vector<CG<Base> > &tzy, CppAD::vector<CG<Base> > &px,
...
template <class Base>
bool time_diff_for_jac_sparse(size_t id, size_t n, size_t m, size_t q, const CppAD::vector<std::set<size_t> > &r,
...
template <class Base>
bool time_diff_rev_jac_sparse(size_t id, size_t n, size_t m, size_t q, CppAD::vector<std::set<size_t> > &r,
...
template <class Base>
bool time_diff_rev_hes_sparse(size_t id, size_t n, size_t m, size_t q, const CppAD::vector<std::set<size_t> > &r,
                              const CppAD::vector<bool> &s, CppAD::vector<bool> &t,
                              const CppAD::vector<std::set<size_t> > &u, CppAD::vector<std::set<size_t> > &v) {
    return false;
}
// ---------------------------------------------------------------------
// Declare the AD<CG<Base> > routine time_var(id, ax, ay)
template <class Base>
CPPAD_USER_ATOMIC(time_var, std::vector, cg::CG<Base>, CppAD::cg::time_diff_forward<Base>,
                  CppAD::cg::time_diff_reverse<Base>, CppAD::cg::time_diff_for_jac_sparse<Base>,
                  CppAD::cg::time_diff_rev_jac_sparse<Base>, CppAD::cg::time_diff_rev_hes_sparse<Base>)
