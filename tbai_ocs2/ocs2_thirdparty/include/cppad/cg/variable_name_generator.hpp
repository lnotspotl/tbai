...
class VariableNameGenerator {
   ...
   public:
     ...
     * @return the generated name
     */
    virtual std::string generateIndexedIndependent(const OperationNode<Base> &var, size_t id,
     ...
     */
    virtual bool isConsecutiveInIndepArray(const OperationNode<Base> &indepFirst, size_t idFirst,
                                           const OperationNode<Base> &indepSecond, size_t idSecond) = 0;
     ...
     */
    virtual bool isInSameIndependentArray(const OperationNode<Base> &indep1, size_t id1,
                                          const OperationNode<Base> &indep2, size_t id2) = 0;
     ...
     */
    virtual bool isConsecutiveInTemporaryVarArray(const OperationNode<Base> &varFirst, size_t idFirst,
                                                  const OperationNode<Base> &varSecond, size_t idSecond) = 0;
     ...
     */
    virtual bool isInSameTemporaryVarArray(const OperationNode<Base> &var1, size_t id1, const OperationNode<Base> &var2,
                                           size_t id2) = 0;
