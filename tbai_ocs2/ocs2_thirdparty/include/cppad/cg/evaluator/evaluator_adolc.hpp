...
inline adouble condExpLt(const adouble &left, const adouble &right, const adouble &exp_if_true,
...
inline adouble condExpLe(const adouble &left, const adouble &right, const adouble &exp_if_true,
                         const adouble &exp_if_false) {
    throw CppAD::cg::CGException("Conditional operation (<=) not implemented in ADOL-C");
}

inline adouble condExpEq(const adouble &left, const adouble &right, const adouble &exp_if_true,
                         const adouble &exp_if_false) {
    throw CppAD::cg::CGException("Conditional operation (==) not implemented in ADOL-C");
}

inline adouble condExpGe(const adouble &left, const adouble &right, const adouble &exp_if_true,
                         const adouble &exp_if_false) {
    throw CppAD::cg::CGException("Conditional operation (>=) not implemented in ADOL-C");
}

inline adouble condExpGt(const adouble &left, const adouble &right, const adouble &exp_if_true,
                         const adouble &exp_if_false) {
    adouble temp;
...
inline adouble condExpNe(const adouble &left, const adouble &right, const adouble &exp_if_true,
                         const adouble &exp_if_false) {
    throw CppAD::cg::CGException("Conditional operation (!=) not implemented in ADOL-C");
}
