...
class EvaluatorBase {
   ...
   public:
     ...
     */
    inline void evaluate(ArrayView<const ActiveOut> indepNew, ArrayView<ActiveOut> depNew,
     ...
     * @throws CGException on error (such as an unhandled operation type)
     */
    inline void evaluate(const ActiveOut *indepNew, size_t indepSize, ActiveOut *depNew, const CG<ScalarIn> *depOld,
                         size_t depSize) {
