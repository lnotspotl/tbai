...
class QuadrupedCom : public tbai::mpc::quadruped_arm::ComModelBase<SCALAR_T> {
 public:
  ...
  tbai::mpc::quadruped_arm::vector3_s_t<SCALAR_T> centerOfMassInBaseFrame(const tbai::mpc::quadruped_arm::joint_coordinate_s_t<SCALAR_T>& jointPositions) const;

  tbai::mpc::quadruped_arm::vector3_s_t<SCALAR_T> centerOfMassInWorldFrame(const tbai::mpc::quadruped_arm::base_coordinate_s_t<SCALAR_T>& basePose,
                                                     const tbai::mpc::quadruped_arm::joint_coordinate_s_t<SCALAR_T>& jointPositions) const;

  tbai::mpc::quadruped_arm::base_coordinate_s_t<SCALAR_T> calculateBaseLocalAccelerations(
      ...
      const tbai::mpc::quadruped_arm::base_coordinate_s_t<SCALAR_T>& forcesOnBaseInBaseFrame) const override;
 ...
 */
extern template class tbai::mpc::quadruped_arm::tpl::QuadrupedCom<ocs2::scalar_t>;
extern template class tbai::mpc::quadruped_arm::tpl::QuadrupedCom<ocs2::ad_scalar_t>;
