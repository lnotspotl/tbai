...
ReferenceTrajectoryGenerator::ReferenceTrajectoryGenerator(
    ...
    defaultJointState_.setZero(JOINT_COORDINATE_SIZE);
...
ocs2::TargetTrajectories ReferenceTrajectoryGenerator::generateReferenceTrajectory(
    ...
    for (size_t i = 0; i < N; ++i) {
        ...
        state.segment(12, JOINT_COORDINATE_SIZE) = defaultJointState_;
...
/*********************************************************************************************************************/
/*********************************************************************************************************************/
void ReferenceTrajectoryGenerator::setTerrainPlane(const tbai::mpc::quadruped_arm::TerrainPlane &plane) {
...
/*********************************************************************************************************************/
/*********************************************************************************************************************/
const tbai::mpc::quadruped_arm::TerrainPlane &ReferenceTrajectoryGenerator::getTerrainPlane() const {
    if (useExternalTerrain_) {
