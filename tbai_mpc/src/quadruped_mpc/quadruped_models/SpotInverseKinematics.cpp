...
tbai::mpc::quadruped::vector3_t SpotInverseKinematics::getLimbJointPositionsFromPositionBaseToFootInBaseFrame(
    ...
    tbai::mpc::quadruped::analytical_inverse_kinematics::spot::getLimbJointPositionsFromPositionBaseToFootInBaseFrame(
        jointAngles, positionBaseToFootInBaseFrame, parameters_[footIndex], footIndex);
    return jointAngles;
}

tbai::mpc::quadruped::vector3_t SpotInverseKinematics::getLimbVelocitiesFromFootVelocityRelativeToBaseInBaseFrame(
