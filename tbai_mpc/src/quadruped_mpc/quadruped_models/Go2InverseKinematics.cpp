...
tbai::mpc::quadruped::vector3_t Go2InverseKinematics::getLimbJointPositionsFromPositionBaseToFootInBaseFrame(
    ...
    tbai::mpc::quadruped::analytical_inverse_kinematics::go2::getLimbJointPositionsFromPositionBaseToFootInBaseFrame(
        jointAngles, positionBaseToFootInBaseFrame, parameters_[footIndex], footIndex);
    return jointAngles;
}

tbai::mpc::quadruped::vector3_t Go2InverseKinematics::getLimbVelocitiesFromFootVelocityRelativeToBaseInBaseFrame(
